    ...
    <>
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
        ...
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-xl font-bold text-dark-900">Create Listing</h2>
          <button
            onClick={onClose}
        ...
        {step === 1 && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className="text-sm">SELL Post</span>
                </button>
                <button
                  onClick={() => setType('buy')}
                  className={`py-3 px-4 rounded-xl border-2 font-semibold transition-all ${
                ...
                >
                  ...
                  <span className="text-sm">BUY Request</span>
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 pl-10 border-2 border-purple-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all text-sm"
                  autoFocus
                />
              </div>
            ...
            {showSuggestions && companies.length > 0 && (
              <div className="max-h-60 overflow-y-auto space-y-2 border-2 border-purple-200 rounded-xl p-2 bg-purple-50">
                <p className="text-xs font-semibold text-purple-700 px-2 py-1">💡 Suggestions ({companies.length})</p>
                {companies.map((company) => (
                  <button
                    key={company._id}
                    onClick={() => handleCompanySelect(company)}
                    className="w-full flex items-center gap-3 p-2.5 bg-white hover:bg-purple-50 rounded-lg transition-all text-left border border-purple-100 hover:border-purple-300 hover:shadow-sm"
                  >
                    {(company.Logo || company.logo) ? (
                      ...
                      <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-400 to-indigo-500 flex items-center justify-center shadow-sm">
            ...
            {searchTerm.length > 0 && (
              <div className="bg-blue-50 border-2 border-blue-300 rounded-xl p-3">
                <p className="text-sm text-dark-700 mb-2">
                  Can't find <span className="font-bold text-blue-700">"{searchTerm}"</span>?
                </p>
                <button
                  type="button"
                  onClick={handleManualEntry}
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-2.5 rounded-xl font-semibold hover:shadow-lg transition-all text-sm"
                >
