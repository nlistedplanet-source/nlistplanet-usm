      ...
      <div className="bottom-sheet p-6">
        ...
        <div className="bg-dark-50 rounded-xl p-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            >
              {listing.type ? listing.type.toUpperCase() : ''}
            </div>
          </div>
        </div>
        ...
        {user && (
          <>
            ...
            {/* Your Referral Code */}
            <div className="mb-6">
              <label className="block text-sm font-semibold text-dark-700 mb-2">Your Referral Code</label>
        ...
        {/* Share URL */}
        <div className="mb-6">
          <label className="block text-sm font-semibold text-dark-700 mb-2">Share Link</label>
          <div className="flex gap-2">
            <input type="text" value={shareURL} readOnly className="flex-1 px-4 py-3 bg-dark-50 border border-dark-200 rounded-xl text-sm" />
            <button onClick={handleCopy} className="btn-mobile bg-primary-600 text-white px-4 flex items-center gap-2">
        ...
        {/* Share Button */}
        <button onClick={handleShare} className="w-full btn-mobile btn-primary flex items-center justify-center gap-2">
          <Share2 size={20} />
          {typeof navigator !== 'undefined' && navigator.share ? 'Share Now' : 'Copy Link'}
        </button>
