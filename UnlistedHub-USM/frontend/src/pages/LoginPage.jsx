...
const LoginPage = () => {
  ...
  const { login, resendVerification, updateEmail, updatePhone, loginWithGoogle } = useAuth();
      ...
      <div className="w-full lg:w-[40%] mx-auto flex flex-col justify-center px-6 py-12">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 rounded-xl font-semibold text-base bg-white text-gray-700 border-2 border-gray-300 hover:bg-gray-50 hover:border-gray-400 focus:ring-4 focus:ring-gray-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-3"
          >
